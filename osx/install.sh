...
PROG_CASK='google-chrome java intellij-idea visualvm sublime-text python3 atom evernote scrivener dropbox virtualbox alfred devonthink-pro github-desktop haskell-platform keepingyouawake'
